...
def generate_show_flowchart():
    ...
    # 输出到 paper/figures（中英文论文共享）
    output_dir = Path(__file__).resolve().parents[2] / "paper" / "figures"
...
def main():
    """生成流程图，输出到 paper/figures/"""
    generate_show_flowchart()
    generate_analytical_framework()
    print("所有流程图已生成到 paper/figures/")
